...
public final class ActivityRestoreBinding implements ViewBinding {
  ...
  private ActivityRestoreBinding(@NonNull LinearLayout rootView,
      ...
      @NonNull MaterialButton cancelButton, @NonNull MaterialCheckBox checkArtistImages,
      @NonNull MaterialCheckBox checkPlaylists, @NonNull MaterialCheckBox checkSettings,
      @NonNull MaterialCheckBox checkUserImages, @NonNull MaterialTextView materialTextView,
      @NonNull MaterialButton restoreButton) {
    this.rootView = rootView;
    this.backupName = backupName;
    this.backupNameContainer = backupNameContainer;
    this.cancelButton = cancelButton;
    this.checkArtistImages = checkArtistImages;
    this.checkPlaylists = checkPlaylists;
    this.checkSettings = checkSettings;
    this.checkUserImages = checkUserImages;
  ...
  public static ActivityRestoreBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.check_artist_images;
      MaterialCheckBox checkArtistImages = ViewBindings.findChildViewById(rootView, id);
      if (checkArtistImages == null) {
        break missingId;
      }
      ...
      id = R.id.check_settings;
      MaterialCheckBox checkSettings = ViewBindings.findChildViewById(rootView, id);
      if (checkSettings == null) {
        break missingId;
      }

      id = R.id.check_user_images;
      MaterialCheckBox checkUserImages = ViewBindings.findChildViewById(rootView, id);
      if (checkUserImages == null) {
        break missingId;
      }
      ...
      return new ActivityRestoreBinding((LinearLayout) rootView, backupName, backupNameContainer,
          cancelButton, checkArtistImages, checkPlaylists, checkSettings, checkUserImages,
          materialTextView, restoreButton);
    }
