...
public final class FragmentFitBinding implements ViewBinding {
  ...
  private FragmentFitBinding(@NonNull FrameLayout rootView,
      @NonNull FragmentContainerView coverLyrics,
  ...
  public static FragmentFitBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentFitBinding((FrameLayout) rootView, coverLyrics, playbackControlsFragment,
          playerAlbumCoverFragment, playerToolbar);
    }
