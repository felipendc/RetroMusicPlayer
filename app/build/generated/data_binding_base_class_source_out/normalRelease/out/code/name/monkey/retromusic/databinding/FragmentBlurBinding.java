...
public final class FragmentBlurBinding implements ViewBinding {
  ...
  private FragmentBlurBinding(@NonNull View rootView, @NonNull AppCompatImageView colorBackground,
      ...
      @NonNull MaterialToolbar playerToolbar, @Nullable FrameLayout statusBarContainer) {
  ...
  public static FragmentBlurBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentBlurBinding(rootView, colorBackground, playbackControlsFragment,
          playerAlbumCoverFragment, playerToolbar, statusBarContainer);
    }
