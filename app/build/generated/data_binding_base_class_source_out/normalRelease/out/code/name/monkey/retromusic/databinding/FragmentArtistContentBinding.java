...
public final class FragmentArtistContentBinding implements ViewBinding {
  ...
  private FragmentArtistContentBinding(@NonNull InsetsConstraintLayout rootView,
      @NonNull RecyclerView albumRecyclerView, @NonNull MaterialButton albumSortOrder,
      @NonNull MaterialTextView albumTitle, @NonNull MaterialTextView biographyText,
      @NonNull MaterialTextView biographyTitle, @NonNull MaterialTextView listeners,
      @NonNull MaterialTextView listenersLabel, @NonNull MaterialButton playAction,
      @NonNull RecyclerView recyclerView, @NonNull MaterialTextView scrobbles,
      @NonNull MaterialTextView scrobblesLabel, @NonNull MaterialButton shuffleAction,
  ...
  public static FragmentArtistContentBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.album_sort_order;
      MaterialButton albumSortOrder = ViewBindings.findChildViewById(rootView, id);
      ...
      return new FragmentArtistContentBinding((InsetsConstraintLayout) rootView, albumRecyclerView,
          albumSortOrder, albumTitle, biographyText, biographyTitle, listeners, listenersLabel,
          playAction, recyclerView, scrobbles, scrobblesLabel, shuffleAction, songSortOrder,
          songTitle);
    }
