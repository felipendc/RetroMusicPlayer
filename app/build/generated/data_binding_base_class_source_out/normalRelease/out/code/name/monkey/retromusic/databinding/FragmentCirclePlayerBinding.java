...
public final class FragmentCirclePlayerBinding implements ViewBinding {
  ...
  private FragmentCirclePlayerBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull FloatingActionButton playPauseButton, @NonNull MaterialToolbar playerToolbar,
  ...
  public static FragmentCirclePlayerBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentCirclePlayerBinding((ConstraintLayout) rootView, albumCover,
          albumCoverOverlay, guideline, materialTextView3, nextButton, playPauseButton,
          playerToolbar, previousButton, progressSlider, songCurrentProgress, songInfo,
          songTotalTime, statusBarContainer, text, title, titleContainer, volumeSeekBar);
    }
