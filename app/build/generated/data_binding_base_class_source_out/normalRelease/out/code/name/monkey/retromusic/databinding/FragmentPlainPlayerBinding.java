...
public final class FragmentPlainPlayerBinding implements ViewBinding {
  ...
  private FragmentPlainPlayerBinding(@NonNull View rootView,
      ...
      @NonNull MaterialTextView title, @Nullable LinearLayout titleContainer) {
  ...
  public static FragmentPlainPlayerBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentPlainPlayerBinding(rootView, playbackControlsFragment,
          playerAlbumCoverFragment, playerToolbar, text, title, titleContainer);
    }
