...
public final class ActivityPermissionBinding implements ViewBinding {
  ...
  private ActivityPermissionBinding(@NonNull ConstraintLayout rootView,
      @NonNull PermissionItem alarmPermission, @NonNull BaselineGridTextView appNameText,
      @NonNull PermissionItem audioPermission, @NonNull PermissionItem bluetoothPermission,
      @NonNull View divider, @NonNull MaterialButton finish,
      @NonNull PermissionItem storagePermission) {
  ...
  public static ActivityPermissionBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.alarm_permission;
      PermissionItem alarmPermission = ViewBindings.findChildViewById(rootView, id);
      ...
      return new ActivityPermissionBinding((ConstraintLayout) rootView, alarmPermission,
          appNameText, audioPermission, bluetoothPermission, divider, finish, storagePermission);
    }
