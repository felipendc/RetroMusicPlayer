...
public final class FragmentHomePlayerBinding implements ViewBinding {
  ...
  private FragmentHomePlayerBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull MaterialToolbar playerToolbar, @NonNull MaterialTextView songTotalTime,
  ...
  public static FragmentHomePlayerBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentHomePlayerBinding((ConstraintLayout) rootView, playerAlbumCoverFragment,
          playerToolbar, songTotalTime, statusBar, text, title, toolbarContainer);
    }
