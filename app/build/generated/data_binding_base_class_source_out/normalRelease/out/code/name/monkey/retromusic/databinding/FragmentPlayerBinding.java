...
public final class FragmentPlayerBinding implements ViewBinding {
  ...
  private FragmentPlayerBinding(@NonNull View rootView, @NonNull View colorGradientBackground,
      @Nullable LinearLayout controlsContainer,
      @NonNull FragmentContainerView playbackControlsFragment,
      @NonNull FragmentContainerView playerAlbumCoverFragment,
      @NonNull MaterialToolbar playerToolbar, @NonNull SnowfallView snowfallView,
  ...
  public static FragmentPlayerBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentPlayerBinding(rootView, colorGradientBackground, controlsContainer,
          playbackControlsFragment, playerAlbumCoverFragment, playerToolbar, snowfallView,
          statusBarContainer);
    }
