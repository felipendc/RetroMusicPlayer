...
public final class FragmentColorPlayerPlaybackControlsBinding implements ViewBinding {
  ...
  public static FragmentColorPlayerPlaybackControlsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentColorPlayerPlaybackControlsBinding((ConstraintLayout) rootView, nextButton,
          playPauseButton, previousButton, progressSlider, repeatButton, shuffleButton,
          songCurrentProgress, songInfo, songTotalTime, text, title, titleContainer,
